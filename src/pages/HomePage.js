      ...
      <div className={isActive ? "wrapper-home-page-ocultar" : "homepage"}>
        ...
        <div className={isActive ? "conainer-center" : "ocultar"}>
          ...
          <div className="center-input">
            ...
            <div className="grades-newpage">
              <div
                onClick={toggleClass}
                className={isActive ? "cancelar" : "ocultar"}
              >
                Cancelar
              </div>
              <div onClick={saveGrades} className="salvar">
                Salvar
              </div>
            </div>
          </div>
        ...
        <div className="contain" onScroll={HandleScroll}>
          <div
            className={
              !scroll
                ? "grades-edit-namePackege"
                : "grades-edit-namePackege grades-edit-namePackege-scroll"
            }
          >
