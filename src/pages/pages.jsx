...
export const PagesGrads = () => {
    ...
    return (
        <>
            {isFirstAccess ? <div className={"wrapper-logoGrades"} onClick={firstAccess}>
                <LogoGradesIcon />
            </div> :
                    ...
                    <div className="mini-wrapper">
                        <div className="wrapper-logo-top">
                            <div className="wrapper-logotop-widtgh">
                                ...
                                <div onClick={toggleClass} className="wrapper-edit-grades">Editar</div>
                            </div>
                        </div>
                        <div className="wrapper-h1-inputVSicon">
                            ...
                            <div className="wrapper-inputIcon-container">
                                <div className="wrapper-inputIcon">
                                    <p><SearchIcon /></p>
                                    <input className="wrapper-input" type="search" placeholder="Buscar" />
                                </div>
                            </div>
                        </div>
